---
title: 📺 tvbox-config 支持 TVBox、FongMi TV、影视仓等客户端
...
comments: true 
cover: 
description: 个人影视仓 / TVBox 配置文件推荐，支持 TVBox、FongMi TV、影视仓等客户端，包含影视、音乐、动漫、直播、看球等多种资源聚合源。
---
...
> 个人影视仓 / TVBox 配置文件，基于 [源码地址](https://github.com/mrgaoshuiquan/tvbox-config) 。
> Personal TVBox configuration, based on [源码地址](https://github.com/mrgaoshuiquan/tvbox-config).
